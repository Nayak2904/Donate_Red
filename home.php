  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\blood-donation-against-painted-blue-sky_1134-68250.avif" alt="Image" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\blood_donationcover.jpeg" alt="image" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to Plasma Hub</h1>
<br>
        <div class="row">
